...
import variablebatch_pb2 as variablebatch__pb2
...
class VariableBatchStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetVariableBatch = channel.unary_unary(
                '/variablebatch.VariableBatch/GetVariableBatch',
...
def add_VariableBatchServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'variablebatch.VariableBatch', rpc_method_handlers)
...
class VariableBatch(object):
    ...
    def GetVariableBatch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/variablebatch.VariableBatch/GetVariableBatch',
